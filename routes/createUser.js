...
router.post('/user',async (req,res,next)=>{
  ...
  await user.create({first_name:req.body.first_name,last_name:req.body.last_name,password:hash,username:req.body.username,account_created:new Date().toISOString()});
